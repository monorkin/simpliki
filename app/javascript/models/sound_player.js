export default class SoundPlayer {
  ...
  playInhaleSound(duration) {
    ...
    // Create oscillator for a smooth tone
    const oscillator = this.audioContext.createOscillator();
    const gainNode = this.audioContext.createGain();
    
    // Configure sound for inhale - start low and rise in pitch
    ...
    gainNode.gain.linearRampToValueAtTime(0.3, this.audioContext.currentTime + durationInSeconds - 0.2);
  ...
  playExhaleSound(duration) {
    ...
    // Configure sound for exhale - start high and lower in pitch
    oscillator.type = 'sine'; // Smooth sine wave
    ...
    gainNode.gain.linearRampToValueAtTime(0.2, this.audioContext.currentTime + durationInSeconds - 0.2);
    gainNode.gain.linearRampToValueAtTime(0, this.audioContext.currentTime + durationInSeconds);
